...
def report(report, test_result):
    ...
    if ref_directory is not None:
        ref_data_directory = os.path.join(ref_directory, "3_random_write", "info")
    ...
    if ref_directory is not None:
        ref_data_directory = os.path.join(ref_directory, "4_random_read", "info")
    ...
    if ref_directory is not None:
        ref_data_directory = os.path.join(ref_directory, "5_sequential_write", "info")
    ...
    if ref_directory is not None:
        ref_data_directory = os.path.join(ref_directory, "6_sequential_read", "info")
